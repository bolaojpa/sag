...
import { ClipboardList, AlertTriangle, LayoutDashboard, FileText } from 'lucide-react';
          ...
          {navItems.map((item) => {
            ...
            return (
              <Link
                key={item.href}
                href={item.href}
                className={`inline-flex items-center gap-2 py-3 px-3 border-b-2 text-xs sm:text-sm font-semibold transition-all ${
                  isActive
